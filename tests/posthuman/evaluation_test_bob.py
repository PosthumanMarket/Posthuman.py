...
# evaluation algorithim: requires INPUT_FILE_LINK and INPUT_FILE env vars., 
# defining the input plaintext file for calculating loss/perplexity.

fp = "examples/data/metadata_evaluation.json"
