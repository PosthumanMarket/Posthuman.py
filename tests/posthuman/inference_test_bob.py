...
# inference algorithim: requires INPUT_FILE_LINK and INPUT_FILE env vars., defining the input plaintext file for continuation.

fp = "examples/data/metadata_inference.json"
